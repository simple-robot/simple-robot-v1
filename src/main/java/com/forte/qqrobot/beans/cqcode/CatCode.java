...

{
     ...
     * @return CQCode实例对象
     */
    public static CatCode of(CQCodeTypes type, String[] params){
        //使用LinkedHashMap
     ...
     * @return CQCode实例对象
     */
    public static CatCode of(String typeStr, String[] params){
        // 获取参数的key列表
     ...
     * @return CQCode实例对象
     */
    public static CatCode of(String typeStr, Map<String, String> params){
     ...
     * @return CQCode实例对象
     */
    public static CatCode of(CQCodeTypes type, Map<String, String> params){
        return new CatCode(type, params);
    }
     ...
     * @return CQ类
     */
    public static CatCode of(String cqStr){
     ...
     * 仅子类构造
     */
    protected CatCode(CQCodeTypes cqCodeTypes, Map<String, String> params){
    ...
    @Override
    public int compareTo(CatCode o) {
