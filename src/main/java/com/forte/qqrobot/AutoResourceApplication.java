...
class AutoResourceApplication<CONFIG extends BaseConfiguration> implements ResourceApplication<CONFIG> {
     ...
     * @return 自动资源配置启动器
     */
    static <CONFIG extends BaseConfiguration> AutoResourceApplication<CONFIG> autoConfig(Class<CONFIG> configClass, SimpleRobotApplication applicationAnnotation, SimpleRobotConfiguration configurationAnnotation){
        ...
        // 返回实例对象
        return new AutoResourceApplication<>(resources, properties);
    }
     ...
     */
    AutoResourceApplication(String resources, Properties properties){
