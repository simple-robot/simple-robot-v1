## 基于酷q机器人LEMOC插件和HTTP API的酷q机器人java开发框架
## 简单说明
...
> 本框架可能存在一些特殊的机制，他们使用起来获取很简单，或者甚至没有在使用他们的感觉，但是解释起来会比较繁琐，于是便使用此大标题来对本框架的部分机制进行介绍、解释，也方便各位去理解本框架。如果你发现了什么不合理的地方或者有什么更好的方案，请告诉我。
